...
public interface ITienDoKhoaHoiService {
     ...
     */
    TienDoKhoaHoc getOrCreateProgress(Long userId, Long khoaHocId) throws DataNotFoundException;
     ...
     */
    void updateProgressAfterPractice(Long userId, Long boCauHoiId, Integer diemSo, java.math.BigDecimal doChinhXac) throws DataNotFoundException;

    /**
     * Lấy progress chi tiết của một bộ câu hỏi trong khóa học
     */
    TienDoBoCauHoiTrongKhoa getOrCreateBoCauHoiProgress(Long tienDoKhoaHocId, Long boCauHoiId) throws DataNotFoundException;

    /**
     * Kiểm tra và tự động unlock bộ câu hỏi tiếp theo nếu đã hoàn thành bộ hiện tại
     */
    void checkAndUnlockNextBoCauHoi(Long userId, Long khoaHocId, Long completedBoCauHoiId) throws DataNotFoundException;
}
