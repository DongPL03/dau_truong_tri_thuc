...
public class BoCauHoiService implements IBoCauHoiService {
    ...
    @Override
    @Transactional
    public BoCauHoi duplicate(Long id, Long currentUserId) throws DataNotFoundException, PermissionDenyException {
        // Lấy bộ câu hỏi gốc
        ...
        BoCauHoi duplicated = BoCauHoi.builder()
                ...
                .isOfficial(false) // Copy không phải official
                .loaiSuDung(original.getLoaiSuDung())
                .isXoa(false)
                .taoBoi(currentUser)
        ...
        for (CauHoi originalQ : originalQuestions) {
            CauHoi duplicatedQ = CauHoi.builder()
                    ...
                    .loaiCauHoi(originalQ.getLoaiCauHoi())
