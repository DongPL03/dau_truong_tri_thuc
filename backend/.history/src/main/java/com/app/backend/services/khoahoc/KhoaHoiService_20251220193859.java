        ...
        for (KhoaHocBoCauHoi khbch : danhSachBoCauHoi) {
            ...
            if (currentUserId != null) {
                ...
                if (isOwner || isAdmin) {
                    ...
                    Long boCauHoiId = khbch.getBoCauHoi() != null ? khbch.getBoCauHoi().getId() : null;
                    if (boCauHoiId != null) {
                        // Kiểm tra unlock status
                        daMoKhoa = boCauHoiMoKhoaRepository.existsByNguoiDung_IdAndBoCauHoi_Id(currentUserId, boCauHoiId);
