...
public enum AchievementCode {
    ...
    QUIZ_SELECTED_FOR_COURSE("QUIZ_SELECTED_FOR_COURSE", "Bộ câu hỏi được chọn", "Bộ câu hỏi của bạn được admin chọn làm bộ câu hỏi khóa học"),
    QUIZ_SELECTED_FOR_RANKED("QUIZ_SELECTED_FOR_RANKED", "Bộ câu hỏi chính thức", "Bộ câu hỏi của bạn được admin chọn làm bộ câu hỏi thi đấu ranked");
