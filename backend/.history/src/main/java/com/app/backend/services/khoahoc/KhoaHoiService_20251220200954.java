...
public class KhoaHoiService implements IKhoaHoiService {
    ...
    public KhoaHoiDetailResponse getDetailById(Long id, Long currentUserId, boolean isAdmin) throws DataNotFoundException, PermissionDenyException {
        ...
        System.out.println("DEBUG KhoaHoiService.getDetailById - START - currentUserId: " + currentUserId + ", isAdmin: " + isAdmin);
        for (KhoaHocBoCauHoi khbch : danhSachBoCauHoi) {
            ...
            if (currentUserId != null) {
                boolean isOwner = khoaHoc.getTaoBoi() != null && khoaHoc.getTaoBoi().getId().equals(currentUserId);
                System.out.println("DEBUG KhoaHoiService.getDetailById - khoaHocBoCauHoi.id: " + khbch.getId() 
                    + ", isOwner: " + isOwner + ", isAdmin: " + isAdmin);
                
                if (isOwner || isAdmin) {
                    daMoKhoa = true;
                    trangThai = "DA_MO_KHOA";
                    System.out.println("DEBUG KhoaHoiService.getDetailById - Bypass unlock (owner/admin)");
                } else {
                    ...
                    System.out.println("DEBUG KhoaHoiService.getDetailById - boCauHoi: " + (boCauHoi != null ? "NOT NULL" : "NULL")
                    ...
                    if (boCauHoiId != null) {
                        ...
                        System.out.println("DEBUG KhoaHoiService.getDetailById - userId: " + currentUserId
                            + ", boCauHoiId: " + boCauHoiId
                            + ", exists: " + exists);
                        daMoKhoa = exists;
                    } else {
                        System.out.println("DEBUG KhoaHoiService.getDetailById - boCauHoiId is NULL for khoaHocBoCauHoi.id: " + khbch.getId());
                    }
                    trangThai = daMoKhoa ? "DA_MO_KHOA" : "CHUA_MO_KHOA";
                }
            } else {
                System.out.println("DEBUG KhoaHoiService.getDetailById - currentUserId is NULL");
            }
