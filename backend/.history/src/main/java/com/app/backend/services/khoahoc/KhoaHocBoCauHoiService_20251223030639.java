...
public class KhoaHocBoCauHoiService implements IKhoaHocBoCauHoiService {
    ...
    public KhoaHocBoCauHoi addBoCauHoiToKhoaHoc(Long khoaHocId, AddBoCauHoiToKhoaHocDTO dto, Long adminId)
        ...
        // Kiểm tra loại sử dụng: chỉ cho phép COURSE_ONLY, COURSE_AND_PRACTICE, hoặc PRACTICE_ONLY
        String loaiSuDung = boCauHoi.getLoaiSuDung();
        if (loaiSuDung != null && 
            !loaiSuDung.equals("COURSE_ONLY") && 
            !loaiSuDung.equals("COURSE_AND_PRACTICE") && 
            !loaiSuDung.equals("PRACTICE_ONLY")) {
            throw new IllegalStateException("Chỉ có thể thêm bộ câu hỏi dành cho khóa học hoặc practice vào khóa học. Bộ câu hỏi này dành cho " + 
                (loaiSuDung.equals("RANKED_ONLY") ? "thi đấu ranked" : "chơi vui casual"));
        }
